...
(function (TSOS) {
    var Shell = /** @class */ (function () {
        ...
        Shell.prototype.init = function () {
            ...
            //Run
            sc = new TSOS.ShellCommand(this.shellRun, "run", "<[empty] | [int]> - Run a program from memory");
            this.commandList[this.commandList.length] = sc;
            //RunAll
            sc = new TSOS.ShellCommand(this.shellRunAll, "runall", "<[empty] | [int]> - Runs all programs from memory");
            this.commandList[this.commandList.length] = sc;
            //Status Bar
